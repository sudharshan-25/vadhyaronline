...
CREATE TABLE event_category (
	event_category_id INT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE event_type (
  event_type_id INT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE soothram_master (
	soothram_id INT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE gothram_master (
	gothram_id INT GENERATED BY DEFAULT AS IDENTITY,
